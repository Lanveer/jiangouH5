...
//                }
                visit_list+='<li onclick="transfer(this)"><span class="am-fl sign-list-icon"><img class="am-circle" src='+item.header_img+' alt=""/></span>' +
                    ...
                    '</div>' +
                    '<span class="am-fr arrow arrow1"><img src="../imgs/basic/meishi/more-arows.png" alt=""/></span>' +'<span class="use_id" style="display: none">'+item.id+'</span>'+'<span class="use_status" style="display: none">'+status_code+'</span>'+
                    '</li>'
            });
...
function transfer(obj){
 ...
 if(s_c==1){
     ...
     window.location.href='img-detail.html?id='+u_id+'&userId='+userId;
 }
}
